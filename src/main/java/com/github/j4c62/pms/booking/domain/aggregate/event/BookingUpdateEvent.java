 ...
 *
 * <p>Applying this event to a {@link Booking} updates the aggregate’s booking dates and
...
public record BookingUpdateEvent(
  ...
  /**
   * Applies this update event to the given {@link Booking}, replacing the current booking

...
/**
 * Component responsible for dispatching domain events produced by a {@link Booking}.
 *
...
public record BookingEventDispatcher(BookingEventPublisher bookingEventPublisher) {
  ...
  /**
   * Dispatches all domain events emitted by the given {@link Booking}.
   *
   ...
   * @since 2025-05-25
   */
  public void dispatch(Booking aggregate) {
    aggregate
        .bookingEvents()
        .events()
